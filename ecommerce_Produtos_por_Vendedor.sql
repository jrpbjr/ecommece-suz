...
CREATE TABLE `Produtos_por_Vendedor` (
  ...
  CONSTRAINT `Produtos_por_Vendedor_ibfk_1` FOREIGN KEY (`Terceiro_Vendedor_idTerceiro`) REFERENCES `Terceiro_Vendedor` (`idTerceiro_Vendedor`),
  CONSTRAINT `Produtos_por_Vendedor_ibfk_2` FOREIGN KEY (`Produto_idProduto`) REFERENCES `Produto` (`idProduto`)
