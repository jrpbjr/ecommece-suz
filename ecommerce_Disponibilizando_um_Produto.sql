...
CREATE TABLE `Disponibilizando_um_Produto` (
  ...
  CONSTRAINT `Disponibilizando_um_Produto_ibfk_1` FOREIGN KEY (`Fornecedor_idFornecedor`) REFERENCES `Fornecedor` (`idFornecedor`),
  CONSTRAINT `Disponibilizando_um_Produto_ibfk_2` FOREIGN KEY (`Produto_idProduto`) REFERENCES `Produto` (`idProduto`)
...
-- Dump completed on 2024-11-09 20:25:12
